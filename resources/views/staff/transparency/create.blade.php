    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2">
            ...
            <div class="bg-white rounded-lg shadow-lg mb-6">
                ...
                <div class="p-6">
                    <form id="transparencyForm" method="POST" action="{{ route('staff.transparency.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-6">
                            ...
                            <textarea class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('data') border-red-500 @enderror" 
                                      ...
                                      placeholder='{"anggaran": 1000000, "realisasi": 800000}'>{{ old('data') }}</textarea>
