...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="flex justify-between items-center mb-6">
            ...
            <nav class="flex mt-2" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    <li class="inline-flex items-center">
                        <a href="{{ route('staff.dashboard') }}" class="text-gray-700 hover:text-blue-600">Dashboard</a>
                    </li>
                    <li>
        ...
        <div class="flex space-x-3">
            <a href="{{ route('transparency.budget') }}" target="_blank" class="inline-flex items-center px-6 py-3 bg-green-600 hover:bg-green-700 text-white font-semibold text-sm rounded-lg transition-all duration-300 shadow-md hover:shadow-lg">
                <i class="fas fa-external-link-alt mr-2"></i> Lihat Portal
            </a>
            <a href="{{ route('staff.transparency.create') }}" class="inline-flex items-center px-6 py-3 bg-[#14213d] hover:bg-[#0f1a2e] text-white font-semibold text-sm rounded-lg transition-all duration-300 shadow-md hover:shadow-lg">
    ...
    <div class="bg-white rounded-lg shadow-lg mb-6">
        ...
        <div class="p-6">
            <form method="GET" action="{{ route('staff.transparency.index') }}">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
                    ...
                    <div>
                        ...
                        <div class="flex space-x-2">
                            ...
                            <a href="{{ route('staff.transparency.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-500 hover:bg-gray-600 text-white font-semibold text-sm rounded-lg transition-all duration-300 shadow-md hover:shadow-lg">
    ...
    <div class="bg-white rounded-lg shadow-lg">
        ...
        <div class="p-6">
            ...
            <div id="bulk-actions" class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6" style="display: none;">
                <form id="bulk-form" method="POST" action="{{ route('staff.transparency.bulk-update') }}">
                    @csrf
                            ...
                            @foreach($transparencies as $transparency)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex space-x-2">
                                            <a href="{{ route('staff.transparency.show', $transparency) }}" 
                                            ...
                                            <a href="{{ route('staff.transparency.edit', $transparency) }}" 
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <a href="{{ route('staff.transparency.create') }}" class="inline-flex items-center px-4 py-2 bg-[#14213d] hover:bg-[#0f1a2e] text-white font-semibold rounded-lg transition-all duration-300 shadow-md hover:shadow-lg">
...
function deleteItem(id) {
    ...
    form.action = `/staff/transparency/${id}`;
