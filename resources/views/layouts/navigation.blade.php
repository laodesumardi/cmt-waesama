            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @elseif(in_array(auth()->user()->role, ['admin', 'staff']))
                        ...
                        <x-nav-link :href="route('admin.complaints.index')" :active="request()->routeIs('admin.complaints.*') || request()->routeIs('staff.complaints.*')">
            ...
            <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
                <div class="pt-2 pb-3 space-y-1">
                    ...
                    @elseif(in_array(auth()->user()->role, ['admin', 'staff']))
                        ...
                        <x-responsive-nav-link :href="route('admin.complaints.index')" :active="request()->routeIs('admin.complaints.*') || request()->routeIs('staff.complaints.*')">
                            {{ __('Manajemen Pengaduan') }}
                        </x-responsive-nav-link>
                    @endif
                </div>
